...
import { useVerifyInstitutionSubscriptionCheckout } from "@workspace/api-client-react";
...
export default function InstitutionSubscriptionReturnPage() {
  const verify = useVerifyInstitutionSubscriptionCheckout();
  ...
  useEffect(() => {
    ...
    verify
      ...
      .then(async (result) => {
        ...
        // Refresh institution-scoped caches so the dashboard unlock surfaces.
        ...
        <CardContent className="p-8 text-center space-y-4">
          ...
          {phase === "trialing" && (
            <>
              ...
              <h1 className="text-2xl font-bold" data-testid="text-sub-trialing-title">
                Free trial started
              </h1>
              <p className="text-muted-foreground">
                Full candidate placement access is unlocked
                {trialEndsAt ? (
                  <>
              ...
              <Button asChild data-testid="button-sub-back-dashboard">
          ...
          {phase === "active" && (
            <>
              ...
              <h1 className="text-2xl font-bold" data-testid="text-sub-active-title">
                Subscription active
              </h1>
              <p className="text-muted-foreground">
                Full candidate placement access is unlocked
          ...
          {phase === "failed" && (
            <>
              ...
              <Button asChild variant="outline">
                <Link href="/dashboard/institution/subscription">Back to subscription</Link>
              </Button>
            </>
          )}
          {phase === "missing" && (
            <>
              ...
              <Button asChild variant="outline">
                <Link href="/dashboard/institution/subscription">Subscribe</Link>
              </Button>
            </>
          )}
        </CardContent>
